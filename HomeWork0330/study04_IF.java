...
//
//        if (num1 > num2) {
//            System.out.println(num1 + "이 더 큼");
//        }
//        if (num2 > num1) {
//            System.out.println(num2 + "이 더 큼");
//        }
...
//        }
        ...
        // "다른 언어를 공부해보세요."를 출력하세요.(switch~case~default 사용)
...
//                break;
//            default:
//                System.out.println("3의 배수 아니야 연진아");
//                break;
//        }
...
//        switch (input) {
//            case "Yes":
//                System.out.println("예 연진아");
//                break;
//            case "No":
//                System.out.println("아니야 연진아");
//                break;
//            default:
//                System.out.println("잘못 입력했어 연진아");
//                break;
//        }
...
//         int num2 = sc.nextInt();
//         if (num1 == num2){
//             System.out.println("두 수가 같아");
//         }
//         else if (num1 > num2){
//             System.out.println("첫 수가 더 커");
//         }
//         if (num1 < num2){
...
//            System.out.println("모두 짝수야 연진아");
//        }
//        else if (num1 % 2 == 0 && num2 % 2 == 0 && num3 % 2 == 1) {
//            System.out.println("짝수 2 홀수 1");
//        }
