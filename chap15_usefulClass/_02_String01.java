...
//        str2 = "naver";
        //문자열을 공유하고 싶지 않으면
        // 새로우 문자열을 생성자를 통해 만든다.
        str2 = new String("naver");
        char[] chArr = {'b', 'i', 't', 'c', 'a', 'm', 'p'};
        String str3 = new String(chArr);
        //같은 문자열인지 비교
        if (str1.equals(str3) && str2.equals(str3)) {
            System.out.println("str1,str2,str3은 같은 문자열입니다");

        } else {
            System.out.println("str1,str2,str3은 다른 문자열입니다");
        }
        //문자열에서 해당 인덱스의 문자 확인
        char ch = str1.charAt(4);
        System.out.println("str1의 index 4에 있는 " + ch + "입니다,");
        //두 문자열 같은지 비교
